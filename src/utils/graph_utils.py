...
def within_distancemain(coord_a, coord_b, radius):
    ...
    # print('*********** within distance debug ************')
    # print(coord_a, coord_b, 'coord a b in within distance')
    # print(dist, 'dist in within distance')
...
def update_shared_attribute_matrixmain(attribute_array, current_robots_array_padded, current_task_array):
    ...
    # print("[debug] old_array_true_ids:", old_array_true_ids)
    # print("[debug] current_task_ids:", current_task_ids)
    # print("[debug] common_task_ids:", common_task_ids)
    # print("[debug] common_task_ids_index:", common_task_ids_index)
    # print(f"[debug] current_robots_array_padded shape: {current_robots_array_padded.shape}")
    # print(f"[debug] current_task_array shape: {current_task_array.shape}")
    # print(f"[debug] attribute_array shape before update: {attribute_array.shape}")
    # print(np.where(np.isin(current_task_array[:, 0], common_task_ids))[0], 'indices of common task ids in current task array')
    # print(common_task_ids_index, 'indices of common task ids in attribute array')
    # print(current_robot_ids, 'current robot ids in padded array')
    # print(current_task_ids, 'current task ids in current task array')

    attribute_array[:len(current_robots_array_padded), :] = current_robots_array_padded
    # print(len(common_task_ids_index), 'number of common task ids to update in attribute array')
    # print(common_task_ids, common_task_ids_index,  'common task ids to update in attribute array')
    # print(len(current_robots_array_padded), 'number of current_robots_array_padded')
    # print(attribute_array.shape, 'attribute array shape before updating common tasks')  
    # print(current_task_array.shape, 'current task array shape')
